export const generateMockData = () => {
  ...
  for (let i = 1; i <= 7; i++) {
    ...
    data.push({
      date: dateStr,
      historical: null,
      forecast: Math.max(forecastVal, 50),
      anomaly: null,
    });
  }
  return data;
...
export const MOCK_INSIGHTS = {
  summary:
    "Your business is currently experiencing a declining trend, primarily driven by severe weekend underperformance.",
  trend: {
    status: "downward",
    text: "Sales decreased 18% over the last 30 days.",
    color: "red",
  },
  anomalies: {
    count: 2,
    text: "Sudden drops & spikes detected recently.",
    color: "red",
  },
  seasonality: {
    pattern: "weekend dips",
    text: "Revenue consistently drops by ~35% on weekends.",
    color: "blue",
  },
  forecast: {
    trend: "downward",
    text: "Expected to decline a further 5% next week.",
    color: "amber",
  },
  recommendations: [
