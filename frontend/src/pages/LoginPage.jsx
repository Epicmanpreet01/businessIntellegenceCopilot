...
import { Mail, Lock, Eye, EyeOff, ArrowRight, BrainCircuit, Sparkles, TrendingUp, BarChart3 } from "lucide-react";
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-20 xl:px-32 z-10 relative">
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0 mt-20 lg:mt-0">
          <motion.div 
            ...
            className="mb-10"
          >
            <h2 className={`text-4xl lg:text-5xl font-black mb-3 ${t.text} tracking-tight`}>Welcome Back</h2>
            <p className={`${t.textMuted} text-lg`}>Log in to access your AI-powered business insights.</p>
          </motion.div>
      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden bg-[#070707]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-16 text-center">
          <div className="max-w-xl space-y-10">
            ...
            >
              Analyze your business in <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600">seconds.</span>
            </motion.h3>
            ...
            >
              Experience the power of generative AI applied to your sales, revenue, and growth data.
            </motion.p>
            ...
            >
              <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-[2rem] text-left hover:bg-white/10 transition-all duration-500 group">
                ...
                <h4 className="text-white font-bold text-xl mb-2">Growth Tracking</h4>
                <p className="text-neutral-500 text-base leading-relaxed">Predict future trends with deep learning models.</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-[2rem] text-left hover:bg-white/10 transition-all duration-500 group">
                ...
                <h4 className="text-white font-bold text-xl mb-2">Smart Analytics</h4>
                <p className="text-neutral-500 text-base leading-relaxed">Automated reporting for complex multi-source data.</p>
              </div>
            </motion.div>
          </div>
        </div>
