...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, BrainCircuit, ShieldCheck, Zap, Globe } from "lucide-react";
    ...
    <div className={`min-h-screen flex w-full ${t.appBg} overflow-hidden`}>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-20 xl:px-32 z-10 relative overflow-y-auto py-16 scrollbar-none">
        ...
        >
          ...
          <span className={`font-bold text-xl tracking-tight ${t.text}`}>Copilot AI</span>
        </motion.div>
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          <motion.div 
            ...
            className="mb-8"
          >
            <h2 className={`text-4xl lg:text-5xl font-black mb-3 ${t.text} tracking-tight`}>Create Account</h2>
            <p className={`${t.textMuted} text-lg`}>Start your journey with the world's most advanced AI BI tool.</p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              <label className={`text-sm font-semibold ${t.textMuted} ml-1`}>Full Name</label>
              <div className="relative group">
                <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${t.textMuted} transition-colors group-focus-within:text-orange-500`} />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div className="space-y-2">
              <label className={`text-sm font-semibold ${t.textMuted} ml-1`}>Email Address</label>
              <div className="relative group">
                <Mail className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${t.textMuted} transition-colors group-focus-within:text-orange-500`} />
                <input
                  type="email"
                  name="email"
            ...
            <div className="space-y-2">
              <label className={`text-sm font-semibold ${t.textMuted} ml-1`}>Password</label>
              <div className="relative group">
                <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${t.textMuted} transition-colors group-focus-within:text-orange-500`} />
                <input
            ...
            <div className="space-y-2">
              <label className={`text-sm font-semibold ${t.textMuted} ml-1`}>Confirm Password</label>
              <div className="relative group">
                <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${t.textMuted} transition-colors group-focus-within:text-orange-500`} />
                <input
                  type={showPassword ? "text" : "password"}
      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden bg-[#070707]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-16 text-center">
          <div className="max-w-xl space-y-10">
            ...
            >
              Scale your business with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600">Intelligence.</span>
            </motion.h3>
            ...
            >
              Join 10,000+ businesses using AI Copilot to drive revenue growth and operational efficiency.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-6 bg-white/5 backdrop-blur-3xl border border-white/10 p-6 rounded-3xl text-left hover:bg-white/10 transition-all duration-500 group">
                ...
                <div>
                  <h4 className="text-white font-bold text-xl mb-1">Enterprise Security</h4>
                  <p className="text-neutral-500 text-base leading-relaxed">Your data is encrypted, private, and never used for training.</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 bg-white/5 backdrop-blur-3xl border border-white/10 p-6 rounded-3xl text-left hover:bg-white/10 transition-all duration-500 group">
                ...
                <div>
                  <h4 className="text-white font-bold text-xl mb-1">Real-time Insights</h4>
                  <p className="text-neutral-500 text-base leading-relaxed">Get answers to complex business questions in milliseconds.</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 bg-white/5 backdrop-blur-3xl border border-white/10 p-6 rounded-3xl text-left hover:bg-white/10 transition-all duration-500 group">
                ...
                <div>
                  <h4 className="text-white font-bold text-xl mb-1">Global Availability</h4>
                  <p className="text-neutral-500 text-base leading-relaxed">Supports all major currencies, regions, and data standards.</p>
                </div>
              </div>
            </motion.div>
          </div>
